<section id="slide_items_angary">
    <div class="container">
        <div class="row">
            <div class="col-lg">
                <div class="h1 mb-lg-5 pb-4"><b>Производим ангары</b><br />Всех назначений</div>
            </div>
            <div class="col-lg">
                <div class="d-none d-lg-flex justify-content-center">
                    ...
                    <div class="j-numerator text-center" data-slider="plSlider">
                        <span class="c_orange j-c_num">1</span><i class="px-1">/</i><span class="j-c_count">2</span>
                    </div>
        ...
        <div id="angarItemsSlider">
            <div>
                <div class="h5">Ангар для спец техники</div>
                <hr class="decor d-block mx-auto">
                <img src="/local/dist/images/angar.sandvichi_teh.png" alt="" class="img-fluid item-pic">
            </div>
            <div>
                <div class="h5">Ангар для животных</div>
                <hr class="decor d-block mx-auto">
                <img src="/local/dist/images/angar.sandvichi_jivot.png" alt="" class="img-fluid item-pic">
            </div>
            <div>
                <div class="h5">Ангар склад</div>
                <hr class="decor d-block mx-auto">
                <img src="/local/dist/images/angar.sandvichi_jivot.png" alt="" class="img-fluid item-pic">
            </div>
        </div>
