    ...
    <form id="<?=$arParams['FORM_ID']?>">
        ...
        <div class="col-md-6 col-lg-3 text-left pl-lg-4 mb-4 mb-lg-0">
            ...
            <div class="col-md-6 col-lg mb-4 mb-lg-0 order-lg-1">
                        ...
                        <div class="custom-control custom-checkbox col-md-6 col-lg px-0 order-lg-2">
                            <input type="checkbox" name="policy" class="custom-control-input" id="policy_<?=$arParams['FORM_ID']?>">
                            <label class="custom-control-label pl-2 politik" for="policy_<?=$arParams['FORM_ID']?>"><b>Согласен с обработкой <br> персональных данных</b></label>
                        </div>
